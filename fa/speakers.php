...
<html lang="fa_IR" dir="rtl">
    <head>
        ...
        <title>سخنرانان کلیدی - چهارمین کنفرانس جبر محاسباتی، نظریه‌ی محاسباتی اعداد و کاربردها</title>
        <!-- Fonts -->
    ...
    <body>
        ...
        <section class="normal normal-less">
            ...
            <ul class="speakers">
                ...
                <li>
                    <img src="/images/shams.jpg" alt="دکتر مهدی شمس">
                    <h4 class="speaker-name">مهدی شمس</h4>
                    <h5 class="speaker-university">دانشگاه کاشان</h5>
                    <h5 class="speaker-university">
                    آمار جبری محاسباتی
                    </h5>
