...
<html lang="fa_IR" dir="rtl">
    ...
    <body>
        ...
        <section class="normal">
            ...
            <b style="color: red;">
                متاسفانه به دلیل فوت غم انگیز و ناگهانی دانشمند جهانی، فرهیخته و عالم پروفسور سید علی رضا اشرفی دبیر علمی کنفرانس، زمان این کنفرانس از اسفند ماه به تیرماه تغییر یافت.
            </b>
            <br>
            ...
            <p>
                ...
                <b>برگزاری چهارمین همایش جبر محاسباتی، نظریه‌ی محاسباتی اعداد و کاربردها (یادبود پروفسور علی‌رضا اشرفی) در تاریخ 14 الی 16 تیر ماه 1402</b>
                <br>
        ...
        <section class="normal time">
            ...
            <ul class="dates">
                ...
                <li>
                    ...
                    <span>
                        سیصد هزار تومان برای دانشجویان و پانصد هزار تومان برای اساتید
                    </span>
                </li>
            </ul>
        </section>
