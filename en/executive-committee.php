    ...
    <body>
        ...
        <section class="normal team">
            ...
            <!-- <ul>
                ...
                <li>
                    سیدعلی محمدیه (گروه ریاضی محض، دانشگاه کاشان)
                </li>
                <li>
                    سعید آسعیدی (گروه علوم کامپیوتر، دانشگاه کاشان)
                </li>
                <li>
                    مرضیه پوربابایی (گروه ریاضی کاربردی، دانشگاه کاشان)
                </li>
                <li>
                    زینب سعیدیان (گروه ریاضی محض، دانشگاه کاشان)
                </li>
                <li>
                    محمد حسن ملکیان (دانشگاه کاشان)
                </li>
                <li>
                    مهدی اسدی (دانشگاه کاشان)
                </li>
                <li>
                    محسن شکریز (دانشگاه کاشان)
                </li>
                <li>
